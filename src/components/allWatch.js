      ...
      {props.watches.map((watch) => (
        <div class="card">
          ...
          <div class="card-body">
            ...
            <h5 class="card-title">
              Price: {watch.price / 1000000000000000000}cUSD
            </h5>

            {props.walletAddress !== watch.owner && (
              <button
                type="button"
                onClick={() => props.buyWatch(watch.index)}
            ...
            {props.walletAddress === watch.owner && (
              <form>
                <div class="form-r">
                  ...
                  <button
                    type="button"
                    onClick={() => props.updatePrice(watch.index, newprice)}
                    class="btn btn-primary mt-2"
                  >
                    Update Price
                  </button>
              ...
              <form>
                <div class="form-r">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      props.updateDescription(watch.index, newdescription)
                    }
                    class="btn btn-primary mt-2"
                  >
                    Update Description
